...
namespace MathLibrary
{
    ...
    public class PointVectorBase
    {
        ...
        /// <summary>
        /// Determines the equality between the current point vector base and the passed object.
        /// </summary>
        /// <param name="obj">The passed object.</param>
        /// <returns>True for equality, otherwise false.</returns>
        public override bool Equals(object obj)
        {
            if (obj is PointVectorBase pvb)
            {
                return Math.Abs(X - pvb.X) <= Tolerance && Math.Abs(Y - pvb.Y) <= Tolerance && Math.Abs(Z - pvb.Z) <= Tolerance;
            }
        ...
        /// <summary>
        /// Calculates the hash code for the current point vector base.
        /// </summary>
